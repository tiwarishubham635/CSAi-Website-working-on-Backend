...
class CommentDisplay extends Component{
    ...
    upvote = () =>{
        ...
        axios.put(`/backend/comments/karma/${this.state.comment._id}`,{vote:vote,user:this.props.username,type:'upvote'})
            .then(res=>{
                this.setState({
    ...
    downvote = () =>{
        ...
        axios.put(`/backend/comments/karma/${this.state.comment._id}`,{vote:vote,user:this.props.username,type:'downvote'})
            .then(res=>{
                this.setState({
                    comment:res.data.comment,
    ...
    renderComment = () =>{
        ...
        <Comment>
            ...
            <Comment.Content>
                ...
                <Comment.Actions>
                    {this.props.username === this.state.comment.author && <Button onClick={this.toggleEdit}>Edit</Button>}
                    {this.props.username === this.state.comment.author && <Button onClick={this.delete}>Delete</Button>}
