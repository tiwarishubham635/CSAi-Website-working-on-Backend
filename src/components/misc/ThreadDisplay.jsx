...
class ThreadDisplay extends Component{
    ...
    upvote = () =>{
        ...
        axios.put(`/backend/threads/karma/${this.state.threadData.id}`,{vote:vote,user:this.props.username,type:'upvote'})
            .then(res=>{
                this.setState({
    ...
    downvote = () =>{
        ...
        axios.put(`/backend/threads/karma/${this.state.threadData.id}`,{vote:vote,user:this.props.username,type:'downvote'})
            .then(res=>{
                this.setState({
                    threadData:res.data.thread,
                    positive:false,
    ...
    submit = (data) =>{
        ...
        data.threadId = this.state.threadData.id
    ...
    renderEdit = () =>{
        return(
            <div>
                <EditForm submit={this.submit} body={this.state.threadData.body} threadId={this.state.threadData.id}/>
